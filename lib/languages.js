...
export default {
  ...
  translationURL(text, l1, l2) {
    ...
    if (translator) {
      let baidu = translator.translators.find(t => t.id === 'baidu')
      // console.log(baidu.langs.map(l => this.getSmart(l)).map(l => l ? l.code : '').join("\n"))
      console.log(baidu.l2Code)
      return translator.url(text, l1, l2)
    }
  },
  getTranslator(l1, l2) {
