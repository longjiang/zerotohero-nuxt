...
export default {
  ...
  constructL1Data() {
    ...
    for (let l1 of l1s) {
      ...
      l1.han = 'cdo cjy cmn cnp cpx csp czo hak hsn mnp nan wuu yue zho'.split(' ').includes(l1['iso639-3'])
    ...
    if (!this.youTubeLangs.includes(locales[0]) && l1['iso639-3']) {
      if (l1.country && l1.country[0]) {
        ...
        if (country.languages && country.languages[0]) {
          ...
          if (countryPrimaryLanguageCode) locales.push(countryPrimaryLanguageCode)
        }
      }
    }
