...
export default {
  ...
  async loadLanguages() {
    ...
    this.l1s = this.constructL1Data(filteredLanguages, { locales, scripts, hours, countries, scripts, wiktionary_langs, wiktionary_mapped_langs, dictionaries, omniglot })
  },
  ...
  constructL1Data(languages, { locales = [], scripts = [], hours = [], countries = [], wiktionary_langs = [], wiktionary_mapped_langs = [], dictionaries = [], omniglot = [] } = {}) {
    /*
     Goal:
    {
      "code": "af",
    ...
    if (!this.youTubeLangs.includes(l1Locales[0]) && l1['iso639-3']) {
      if (l1.country && l1.country[0]) {
        ...
        if (country.languages && country.languages[0]) {
          ...
          l1Locales = l1Locales.concat([countryPrimaryLanguageCode, ...countryPrimaryLanguageLocales])
        }
        if (country.name === "Philippines") l1Locales.push('fil')
      }
    }
    l1.locales = Helper.unique(l1Locales)
  },
