...
export default {
  ...
  getFeatures({ l1, l2 }, browser) {
    if (!l1.moreFeatures) l1.moreFeatures = {}
    if (l1.moreFeatures[l2['iso639-3']]) {
      if (!l1.moreFeatures[l2['iso639-3']].includes('speech') && this.checkSpeech(l2, browser)) l1.moreFeatures[l2['iso639-3']].push('speech')
      return l1.moreFeatures[l2['iso639-3']]
    }
    ...
    l1.moreFeatures[l2['iso639-3']] = features
    return features
  },
  logo(code) {
    if (code === 'en') {
