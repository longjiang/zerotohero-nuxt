...
export default {
  ...
  async load() {
    ...
    this.googleTranslateLangs = data.googleTranslateLangs.split(' '),
    this.baiduTranslateLangs = data.baiduTranslateLangs.split(' '),
  ...
  constructL1Data() {
    ...
    for (let l1 of l1s) {
      ...
      if (l1.glottologId === 'leiz1236') l1.han = true
