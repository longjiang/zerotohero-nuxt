...
export default {
  ...
  getFeatures({ l1, l2 }, browser) {
    ...
    if (l1.moreFeatures[l2['iso639-3']]) {
      if (!l1.moreFeatures[l2['iso639-3']].includes('speech') && this.checkSpeech(l2)) l1.moreFeatures[l2['iso639-3']].push('speech')
    ...
    if (!features.includes('speech') && this.checkSpeech(l2)) features.push('speech')
