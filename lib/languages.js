...
export default {
  ...
  async load() {
    ...
    let languages = this.loadCSVString(res.data)
    ...
    res = await axios.get(`${process.env.baseUrl}/data/languages/scripts.csv.txt`)
    this.scripts = this.loadCSVString(res.data)
    ...
    this.l1s = this.constructL1Data(filteredLanguages, { wiktionary_langs, dictionaries })
    delete this.data
    delete this.omniglot
    return this
  },
  loadFile(file) {
  ...
  constructL1Data(languages, { wiktionary_langs = [], dictionaries = [] } = {}) {
    /*
     Goal:
    {
      "code": "af",
    ...
    let all_wiktionary_langs = wiktionary_langs.concat(this.wiktionary_mapped_langs)
