...
export default {
  ...
  async load() {
    ...
    this.l1s = this.constructL1Data(filteredLanguages, { wiktionary_langs, dictionaries, omniglot })
    delete this.data
    return this
  },
  loadFile(file) {
  ...
  constructL1Data(languages, { wiktionary_langs = [], dictionaries = [], omniglot = [] } = {}) {
    /*
     Goal:
    {
      "code": "af",
