...
const addDictionaryNameToL1 = (dictionaryName, l1Obj, l2_iso_639_3) => {
  if (l1Obj.code !== 'en') console.log('Adding dictionary', dictionaryName, 'to', l1Obj.code, l2_iso_639_3)
  ...
  supportedL1s(iso639_3, preferredL1Code = null) {
    ...
    let supportedL1s = this.l1s.filter(
      (language) => {
        ...
        const hasTranslatedDictionary = LANGS_WITH_AZURE_TRANSLATE.includes(language.code) && englishLanguage.dictionaries[iso639_3];
        return isCommonLanguage && (hasDictionary || hasTranslatedDictionary);
      }
    );
    return supportedL1s;
    const codesByPopularity = "en zh ko it es fr ja de tr ru nl sv pl no id th ca pt vi he el uk cs ar".split(" ")
  },
};
