...
export default {
  ...
  async concordance(options) {
    ...
    // Searching a phrase like "感谢你"
    // However, SketchEngine has difficulty searching phrases, either too slow or returning nothing at all.
    if (options.searchAsPhrase) {
      ...
      // Searching a single word like "感谢"
