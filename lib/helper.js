...
export default {
  ...
  async speak(text, l2, rate = 0.75, volume = 1, localOnly = false) {
      ...
      if (bestVoice) {
        ...
        try {
          await new Promise(function (resolve, reject) {
            ...
            utterance.onmark = (a) => { console.log(a, 'onmark')}
            utterance.onpause = (a) => { console.log(a, 'onpause')}
            utterance.onresume = (a) => { console.log(a, 'onresume')}
            utterance.onstart = (a) => { console.log(a, 'onstart')}
