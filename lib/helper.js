...
export default {
  ...
  background(l2 = undefined) {
    ...
    else if (!l2['iso639-1']) background = "/img/background-branch.jpg"; 
    else background = `https://source.unsplash.com/1600x900/?${l2.name}`;
    return background
  },
  translationURL(text, l1, l2) {
    let url
    let googleTranslateLangs = 'af am ar az be bg bn bs ca ceb co cs cy da de el en eo es et eu fa fi fr fy ga gd gl gu ha ha he hi hm hr ht hu hy id ig is it iw ja jw ka kk km kn ko ku ky la lb lo lt lv mg mi mk ml mn mr ms mt my ne nl no ny pa pl ps pt ro ru sd si sk sl sm sn so sq sr st su sv sw ta te tg th tl tr uk ur uz vi xh yi yo zh zh zu'
    if ([l2.code, l1.code].includes("zh") || l2.han) {
      url = `https://fanyi.baidu.com/#${l2.code}/${l1.code}/${text}`;
      if (l2.code === "lzh")
    ...
    } else if (googleTranslateLangs.split(" ").includes(l2.code)) {
      url = `https://translate.google.com/#view=home&op=translate&sl=${l2.code === "zh" ? "zh-CN" : l2.code
