...
export default {
  ...
  background(l2 = undefined) {
    let background
    if (typeof l2 === 'undefined') background = "/img/background-branch.jpg";
    else if (["dz", "pau", "ps", "lzh", "zh"].includes(l2.code))
