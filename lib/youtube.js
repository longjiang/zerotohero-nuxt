...
export default {
  ...
  async searchSubs({ terms, excludeTerms, lang = 'en', langId = 1824, tvShowFilter = "all", talkFilter = "all", adminMode = false, continua = true, limit = 20, exact = false, apostrophe = false, convertToSimplified = false } = {}) {
    ...
    if (limit) {
      ...
      hits = hits.concat(await this.searchWithLike({ terms, langId, filter: undefined, tvShowFilter, talkFilter, adminMode, excludeTerms, continua, limit, exact, apostrophe, convertToSimplified }))
    }
