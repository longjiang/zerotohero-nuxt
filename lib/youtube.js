import { proxy, unique, scrape, youtubeVideo, lrcServer, youtubeChannelPlaylists } from "@/lib/utils";
...
export default {
  ...
  async getL1Transcript(originalVideo, $l1, $l2, $adminMode = false) {
    ...
    if (missingSubsL1) {
      console.log(
        `YouTube: Getting available L1 transcripts...`
      );
      ...
      console.log(
        `YouTube: Getting ${$l1.name} transcript`
      );
      let subs_l1;
