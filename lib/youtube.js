...
export default {
  ...
  async searchWithLike(terms, lang, langId, filter, adminMode, excludeTerms, continua, limit = 20, limitToTVShow = false, exact = false, apostrophe = false) {
    let showFilter = ''
  ...
  async searchSubs(terms, excludeTerms, lang = 'en', langId = 1824, adminMode = false, continua = true, limit = 20, limitToTVShow = false, exact = false, apostrophe = false) {
    let hits = []
