...
zu	zul`,
    ...
    },
    {
      id: 'bing',
      name: 'Bing Translate',
      langs: 'af am ar as az bg bn bs ca cs cy da de el en es et fa fi fil fj fr ga gu he hi hr ht hu hy id is it iu ja kk km kmr kn ko ku lo lt lv lzh mg mi ml mr ms mt mww my nb ne nl or otq pa pl prs ps pt ro ru sk sl sm sq sv sw ta te th ti tlh to tr ty uk ur vi yua yue zh',
      map: `zh	zh-Hans
tlh	tlh-Latn
sr	sr-Cyrl`
    },
...
sr	sr-Cyrl`
  ...
  url(text, l1, l2) {
    ...
    if ([l2.code, l1.code].includes("zh") || l2.han) {
      ...
      url = yandex.url(text, yandex.l1Code, l2)
