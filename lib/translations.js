export default {
  ...
  jpn: {
    ...
    'Beginner II': '初級 II',
    'Beginner III': '初級 III',
    'Intermediate I': '中級 I・IELTS 4-5',
    'Intermediate II': '中級 II・IELTS 5.5-6.5',
    'Advanced I': '上級 I・IELTS 7-8',
    'Advanced II': '上級 II・IELTS 8.5-9',
    'Blog': 'ブログ',
    'Books': '書籍',
    ...
    'Import from YouTube': 'YouTubeからインポートする',
    'in passive': '受け身で',
    ...
    'Reading': '読書',
    'Recommended': 'おすすめ',
    'Recommended Channels': 'おすすめのチャネル',
    'Reddit': 'レディット',
    ...
    'See more languages on a map': '地図に言語の分布を見る',
    ...
    'Watch History': '視聴履歴',
    'Web Reader': 'Webリーダー',
    'Web Translators': 'オンライン翻訳',
    'Welcome back': 'おかえりなさい',
    'wh-words following "{word}"': 'wordの後に続くwhワード',
    'What is your mother tongue (first/native language)?': '母国語は何ですか?',
    'What’s your level of English?': 'あなたの英語熟練度はどのくらいですか。',
    'What’s New': '新着情報',
    'Which language would you like to learn?': 'どの言語を学びたいですか？',
    'Which categories of content interest you?': 'どのカテゴリーに興味がありますか',
    'Wiki': 'Wiki',
    'Words': '言葉',
    ...
    'Non-profits & Activism': '非営利団体と社会活動',
    'Anime/Animation': '日本のアニメ',
