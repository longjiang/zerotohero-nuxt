...
export const cjk = /[\u4E00-\u9FCC\u3400-\u4DB5\uFA0E\uFA0F\uFA11\uFA13\uFA14\uFA1F\uFA21\uFA23\uFA24\uFA27-\uFA29]+/gi
export const nonCjk = /[^\u4E00-\u9FCC\u3400-\u4DB5\uFA0E\uFA0F\uFA11\uFA13\uFA14\uFA1F\uFA21\uFA23\uFA24\uFA27-\uFA29]+/gi
...
export const l1Code = (l2Code) => {
  let l1 = "en";
  let special = specialLanguages[l2Code];
...
export const speak = (text, l2, rate = 0.75, volume = 1, localOnly = false) => {
...
export const characterClass = (category) => {
  // Letter
...
export const background = (l2 = undefined) => {
  if (!l2) return backgroundImages.default
