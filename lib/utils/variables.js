...
export const SALE_START_DATE = new Date(2024, 7, 24); // Aug 24, 2024. The month is 0-indexed.

export const SALE_END_DATE = new Date(2024, 7, 31); // Aug 31, 2024. The month is 0-indexed.
