...
export const SALE_START_DATE = new Date(2025, 9, 1); // Oct 1, 2025. The month is 0-indexed.

export const SALE_END_DATE = new Date(2025, 9, 7, 23, 59, 59, 999); // End of Oct 7, 2025.
