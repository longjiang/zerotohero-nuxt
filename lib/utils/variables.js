...
export const SALE_START_DATE = new Date(2025, 0, 25); // Jan 25, 2025, Lunar New Year. The month is 0-indexed.

export const SALE_END_DATE = new Date(2025, 0, 31, 23, 59, 59, 999); // End of Jan 31, 2025.
