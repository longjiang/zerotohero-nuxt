...
export const SALE_NAME = "NEW YEAR";

export const SALE_START_DATE = new Date(2025, 0, 1); // Jan 1, 2025, New Year. The month is 0-indexed.

export const SALE_END_DATE = new Date(2025, 0, 5, 23, 59, 59, 999); // End of Jan 5, 2025.
