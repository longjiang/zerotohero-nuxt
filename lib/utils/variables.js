...
export const SALE_START_DATE = new Date(2025, 10, 24); // Nov 26, 2025. The month is 0-indexed.

export const SALE_END_DATE = new Date(2025, 11, 1, 23, 59, 59, 999); // End of Dec 1, 2025.
