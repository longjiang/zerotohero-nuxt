...
export const SALE_NAME = "DRAGON BOAT FESTIVAL";

export const SALE_START_DATE = new Date(2024, 5, 10); // June 10, 2024. The month is 0-indexed.

export const SALE_END_DATE = new Date(2024, 5, 12); // June 12, 2024. The month is 0-indexed.

// Determine if the sale is on.
export const SALE = new Date() >= SALE_START_DATE && new Date() <= SALE_END_DATE;

export const SALE_DISCOUNT = 0.8;
