...
export const SALE_NAME = "SPRING";

export const SALE_START_DATE = new Date(2025, 3, 15); // Apr 15, 2025. The month is 0-indexed.

export const SALE_END_DATE = new Date(2025, 3, 20, 23, 59, 59, 999); // End of Apr 20, 2025.
