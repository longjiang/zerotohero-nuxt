...
export const SALE_NAME = "BACK TO SCHOOL";

export const SALE_START_DATE = new Date(2024, 7, 25); // Aug 15, 2024. The month is 0-indexed.

export const SALE_END_DATE = new Date(2024, 7, 31); // Aug 21, 2024. The month is 0-indexed.

// Determine if the sale is on.
export const SALE = new Date() >= SALE_START_DATE && new Date() <= SALE_END_DATE;

export const SALE_DISCOUNT = 0.55;
