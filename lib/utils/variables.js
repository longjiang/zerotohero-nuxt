...
export const SALE_NAME = "CHONGYANG FESTIVAL";

export const SALE_START_DATE = new Date(2024, 9, 11); // Oct 11, 2024, Chongyang Festival. The month is 0-indexed.

export const SALE_END_DATE = new Date(2024, 9, 14, 23, 59, 59, 999); // End of Oct 14, 2024.

export const SALE = new Date() >= SALE_START_DATE && new Date() <= SALE_END_DATE;

export const SALE_DISCOUNT = 0.65; // 0.65 means 35% off

export const DEFAULT_PAGE = "l1-l2-explore-media"; // The page that the user is redirected to after logging in. Options are "recommended-video", "explore-media"
