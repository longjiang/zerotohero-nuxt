...
export const SALE_START_DATE = new Date(2025, 7, 25); // Aug 7, 2025. The month is 0-indexed.

export const SALE_END_DATE = new Date(2025, 7, 31, 23, 59, 59, 999); // End of Aug 31, 2025.
