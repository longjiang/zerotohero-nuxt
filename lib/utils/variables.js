...
export const SALE_NAME = "SINGLES DAY";

export const SALE_START_DATE = new Date(2025, 10, 11); // Nov 11, 2025. The month is 0-indexed.

export const SALE_END_DATE = new Date(2025, 10, 14, 23, 59, 59, 999); // End of Nov 14, 2025.
