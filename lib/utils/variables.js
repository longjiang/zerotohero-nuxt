...
export const SALE_NAME = "BLACK FRIDAY";

export const SALE_START_DATE = new Date(2024, 10, 24); // Nov 24, 2024, Black Friday. The month is 0-indexed.

export const SALE_END_DATE = new Date(2024, 11, 3, 23, 59, 59, 999); // End of Cyber Monday Dec 3, 2024.

export const SALE = new Date() >= SALE_START_DATE && new Date() <= SALE_END_DATE;

export const SALE_DISCOUNT = 0.5; // 0.65 means 35% off
