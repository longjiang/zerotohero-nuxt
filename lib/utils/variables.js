...
export const SALE_NAME = "MID-AUTUMN FESTIVAL";

export const SALE_START_DATE = new Date(2024, 8, 17); // Sep 17, 2024. The month is 0-indexed.

export const SALE_END_DATE = new Date(2024, 8, 20, 23, 59, 59, 999); // End of Sep 20, 2024.
