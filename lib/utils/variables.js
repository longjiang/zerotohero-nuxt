...
export const SALE_NAME = "CHINESE NEW YEAR";

export const SALE_START_DATE = new Date(2026, 1, 9); // Feb 9, 2026. The month is 0-indexed.

export const SALE_END_DATE = new Date(2026, 1, 20, 23, 59, 59, 999); // End of Feb 20, 2026. The month is 0-indexed.
