import { DIRECTUS_API_URL, DIRECTUS_ADMIN_URL } from '../directus'
export { youtubeVideosTableName } from '../directus'
export const wiki = DIRECTUS_API_URL
export const wikiAdmin = DIRECTUS_ADMIN_URL
