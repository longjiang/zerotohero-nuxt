import { proxy, PYTHON_SERVER, IMAGE_URL, SAVE_PHOTO_URL } from "./utils"
...
export default {
  ...
  async getGoogleImages(options) {
    ...
    let listURL = `${PYTHON_SERVER}/images/${encodeURIComponent(options.term)}/${options.lang !== 'en' ? options.lang : ''}`

    let images = await axios.get(listURL)
