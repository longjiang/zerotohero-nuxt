...
export default {
  file: `${process.env.baseUrl}/data/hsk-cedict/hsk_cedict.csv.txt`,
  characterFile: `${process.env.baseUrl}/data/hsk-cedict/hsk_characters.csv.txt`,
  newHSKFile: `${process.env.baseUrl}/data/hsk-cedict/new_hsk.csv.txt`,
  words: [],
  characters: [],
  newHSK: [],
  _maxWeight: 0,
