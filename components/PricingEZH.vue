    ...
    <div class="col-sm-12">
      ...
      <table class="table table-bordered pricing-table" :key="key">
        ...
        <tbody class="table-hover">
          <tr>
            <td class="text-left text-light" data-bg-level="A2">
              英语英雄3级（欧标A2）
            </td>
          ...
          <tr>
            <td class="text-left text-light" data-bg-level="B1">
              英语英雄4级（欧标B1）
            </td>
            <td class="text-center">
          ...
          <tr>
            <td class="text-left text-light" style="background-color: #004d81">
              <a
                href="https://wazuc.duanshu.com/#/course/278543abd13b4dbcb5dfa6458803fd1c"
              >
                流利之路
              </a>
            </td>
