<template>
  <div class="feed-item-word" v-if="word">
    <div class="row">
      <div class="col-sm-6">
        <div>
        ...
        <div v-if="hit">
          <span v-html="highlightMultiple(hit.line, savedWord.forms, 'outside')"></span>
        </div>
      </div>
      <div class="col-sm-6">
        <div v-if="hit">
          <div
            class="youtube-thumbnail-wrapper aspect-wrapper play-button-wrapper"
          >
