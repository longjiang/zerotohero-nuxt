      ...
      <div class="row mt-5">
        ...
        <div class="col-12 col-md-7 offset-0 offset-md-1">
          <Annotate tag="div" class="col-12 mb-4">
            <h3>In China?</h3>
            <p>
             Aside from buying it from a physical bookstore, it may be more convenient to just order them online and have them delivered to your door. Here are some options to purchase online.
            </p>
            <!-- .et_pb_text -->
            <div>
              <a
          ...
          <Annotate tag="div" class="col-12 mb-4">
            ...
            <p>
             If you're outside of China, you'll need to purchase them online. One option would be PurpleCulture.net, it's a Hong Kong based online store dedicated in providing Chinese cultural and educational products. They stock all of the HSK Standard Course textbooks and workbooks, and provide worldwide shipping. Alternatively, Amazon has most of the books in stock as well.
            </p>
            <!-- .et_pb_text -->
            <div>
              <a
            ...
            <div>
              <a
                data-bg-level="3"
                class="btn"
                href="https://www.amazon.com/s?k=hsk+textbook&crid=19ME84EF729SC&sprefix=hsk+%2Caps%2C206">Amazon
              </a>
            </div>
          </Annotate>
          <Annotate tag="div" class="col-12">
            ...
            <p>
              The official publisher (BLCUP) has finally released the textbooks/workbooks in eBook format (flipviewer only for Windows PC as of now).

             You'd have to register an account, then select a textbook/workbook and click on the "eBook: view" above the "Buy" button.
            </p>
            <!-- .et_pb_text -->
            <div>
              <a
                data-bg-level="3"
                class="btn mb-3"
                href="https://www.blcup.com/EnSeriesBook/index/8#001">Official Publisher
              </a>
            </div>
