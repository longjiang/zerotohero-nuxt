export default {
  ...
  head: {
    ...
    link: [
      ...
      {
        rel: "stylesheet",
        href: "/vendor/fontawesome-free-5.15.4-web/css/all.min.css",
      },
  ...
  auth: {
    ...
    strategies: {
      local: {
        ...
        endpoints: {
          login: {
            url: "https://directusvps.zerotohero.ca/zerotohero/auth/authenticate",
            method: "post",
          },
          refresh: {
            url: "https://directusvps.zerotohero.ca/zerotohero/auth/refresh",
            method: "post",
          },
          logout: {
            url: "https://directusvps.zerotohero.ca/zerotohero/auth/logout",
            method: "post",
          },
          user: false,
        },
