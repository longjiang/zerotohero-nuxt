      ...
      <div class="row mt-4" v-if="language('en')">
        <div class="col-sm-6 col-md-4 mb-4">
          <div class="home-card p-4">
            <div class="text-center">
              <router-link :to="`/en/zh/recommended-video`" class="link-unstyled">
                <LanguageFlag
              ...
              <div class="row mt-4">
                <div class="col-6 col-sm-12 col-md-12 col-lg-6">
                  ...
                  >
                    ...
                    <li style="white-space: nowrap">
                      <router-link to="/en/yue/recommended-video" class="link-unstyled">
                        <b>Cantonese</b>
                      </router-link>
                    </li>
                    <li style="white-space: nowrap">
                      <router-link to="/en/ltc/recommended-video" class="link-unstyled">
                        Middle Chinese
                      </router-link>
                    </li>
                    <li style="white-space: nowrap">
                      <router-link to="/en/och/recommended-video" class="link-unstyled">
                        Old Chinese
                      </router-link>
                    </li>
                  </ul>
                ...
                <div class="col-6 col-sm-12 col-md-12 col-lg-6">
                  ...
                  >
                    <li style="white-space: nowrap">
                      <router-link to="/en/wuu/recommended-video" class="link-unstyled">
                        Wu
                      </router-link>
                    </li>
                    <li style="white-space: nowrap">
                      <router-link to="/zh/nan/recommended-video" class="link-unstyled">
                        学习闽南话
                      </router-link>
                    </li>
                    <li style="white-space: nowrap">
                      <router-link to="/zh/hak/recommended-video" class="link-unstyled">
                        学习客家话
                      </router-link>
                    </li>
                    <li style="white-space: nowrap">
                      <router-link to="/zh/lzh/recommended-video" class="link-unstyled">
                        学习文言文
                      </router-link>
                    </li>
                  </ul>
        ...
        <div class="col-sm-6 col-md-4 mb-4">
          <div class="home-card p-4">
            <div class="text-center">
              <router-link
                :to="`/${browserLanguage}/en/recommended-video`"
                class="link-unstyled"
              >
                <LanguageFlag
              ...
              <div class="row mt-4">
                <div class="col-6 col-sm-12 col-md-12 col-lg-6">
                  ...
                  >
                    <li style="white-space: nowrap">
                      <router-link to="/ru/en/recommended-video" class="link-unstyled">
                        Выучить англ. язык
                      </router-link>
                    </li>
                    <li style="white-space: nowrap">
                      <router-link to="/de/en/recommended-video" class="link-unstyled">
                        Lerne Englisch
                      </router-link>
                    </li>
                    <li style="white-space: nowrap">
                      <router-link to="/pt/en/recommended-video" class="link-unstyled">
                        Aprender inglês
                      </router-link>
                    </li>
                    <li style="white-space: nowrap">
                      <router-link to="/es/en/recommended-video" class="link-unstyled">
                        Aprende inglés
                      </router-link>
                    </li>
                  </ul>
                ...
                <div class="col-6 col-sm-12 col-md-12 col-lg-6">
                  ...
                  >
                    <li style="white-space: nowrap">
                      <router-link to="/fr/en/recommended-video" class="link-unstyled">
                        Apprendre l’anglais
                      </router-link>
                    </li>
                    <li style="white-space: nowrap">
                      <router-link to="/zh/en/recommended-video" class="link-unstyled">
                        学英语
                      </router-link>
                    </li>
                    <li style="white-space: nowrap">
                      <router-link to="/ja/en/recommended-video" class="link-unstyled">
                        英語を習う
                      </router-link>
                    </li>
                    <li style="white-space: nowrap">
