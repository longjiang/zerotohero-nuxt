          ...
          <div v-if="$route.params.l1 && $route.params.l1 && $l1 && $l2">
            <div class="pb-2">
              ...
              <div class="language-data">
                ...
                <p v-if="$l2['glottologFamilyId'] && $l2['glottologFamilyId'].length">
                  <b>{{ $t("Glottolog Family ID:") }}</b>
                  {{ $l2["glottologFamilyId"] }}
                </p>
                <p v-if="$l2['glottologParentId'] && $l2['glottologParentId'].length">
                ...
                <p v-if="$l2.otherNames && $l2.otherNames.length > 0">
                  <b>{{ $t("Other names:") }}</b>
                  {{ $l2.otherNames.join(",") }}
                </p>
                ...
                <p>
                  ...
                  >
                    ...
                    />
                    {{ c.name }}
                    <span v-if="c.languages && c.languages.length > 0">
                      ({{ $t("Also speaks:") }}
                      <span
