...
const TokenizerFactory = {
  tokenizers: {
    ...
    LemmatizationListTokenizer: ["ast", "bul", "cat", "ces", "cym", "deu", "est", "fas", "fra", "gla", "gle", "glg", "glv", "hun", "ita", "por", "ron", "rus", "slk", "slv", "spa", "swe", "ukr"], // tokenized and lemmatized by lemmatization list
  },
